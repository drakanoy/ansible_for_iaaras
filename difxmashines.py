...
#
# $Id: difxmachines.py 7902 2017-07-12 15:10:44Z JanWagner $
# $HeadURL: https://svn.atnf.csiro.au/difx/master_tags/DiFX-2.6.2/libraries/python/difxfile/difxmachines.py $
# $LastChangedRevision: 7902 $
# $Author: JanWagner $
# $LastChangedDate: 2017-07-12 18:10:44 +0300 (??, 12 ??? 2017) $
#
# ============================================================================
...
class Node:
    ...
    def __str__(self):
        result = "name=%s threads=%s isHeadnode=%s isMk5=%s isMk6=%s fileUrls=%s networkUrls=%s" % (
        self.name, self.threads, self.isHeadnode, self.isMk5, self.isMk6, self.fileUrls, self.networkUrls)
        print(result, 'ahahhahaahahhahahh python mashine')
        return (result)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print
        "Give full path to machinefile as first argument"
        sys.exit(1)
